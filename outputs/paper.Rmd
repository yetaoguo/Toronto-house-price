...
rawdata %>%
  ggplot(aes(x = `Mid-Century_Highrise_Households`)) + 
  geom_histogram(
    fill = 'blue',
    alpha = 0.6,
    bins = 8,
  ...
  geom_density() +
  xlab("Mid-Century Highrise Households") +
  ylab("Frequency")
...
rawdata %>%
  ggplot(aes(x = `Mid-Century_Highrise_Population`)) + 
  geom_histogram(
    fill = 'blue',
    alpha = 0.6,
    bins = 8,
  ...
  geom_density() +
  xlab("Mid-Century Highrise Population") +
  ylab("Frequency")
...
rawdata %>%
  ggplot(aes(x = `Percent_Mid-Century_Highrise_Households`)) + 
  geom_histogram(
    fill = 'blue',
    alpha = 0.6,
    bins = 8,
  ...
  geom_density() +
  xlab("Percent Mid-Century Highrise Households") +
  ylab("Frequency")
...
rawdata %>%
  ggplot(aes(x = `Percent_Mid-Century_Highrise_Population`)) + 
  geom_histogram(
    fill = 'blue',
    alpha = 0.6,
    bins = 8,
  ...
  geom_density() +
  xlab("Percent Mid-Century Highrise Population") +
  ylab("Frequency")
...
rawdata %>%
  ggplot(aes(x = Rent_Bank_Applicants)) + 
  geom_histogram(
    fill = 'blue',
    alpha = 0.6,
    bins = 8,
...
rawdata %>%
  ggplot(aes(x = Social_Housing_Turnover)) + 
  geom_histogram(
    fill = 'blue',
    alpha = 0.6,
    bins = 8,
...
rawdata %>%
  ggplot(aes(x = Social_Housing_Units)) + 
  geom_histogram(
    fill = 'blue',
    alpha = 0.6,
    bins = 8,
...
rawdata[, -c(1, 2)] %>%
  corrgram(
    ...
    main = "Corrgram of Toronto Home Prices Intercorrelations"
  )
